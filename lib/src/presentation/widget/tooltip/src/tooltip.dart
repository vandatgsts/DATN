...
class _SuperTooltipState extends State<SuperTooltip>
  ...
  TooltipController? _superTooltipController;
  OverlayEntry? _entry;
  ...
  void initState() {
    ...
    _superTooltipController = widget.controller ?? TooltipController();
                  ...
                  Material(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: Utils.getTooltipPadding(
                          closeButtonSize: closeButtonSize,
                          showCloseButton: showCloseButton,
                        ).copyWith(
                          top: 10,
