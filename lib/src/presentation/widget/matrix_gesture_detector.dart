...
import 'package:ar_drawing/src/utils/share_preference_utils.dart';
...
class _MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    if (widget.shouldScale && details.scale != 1.0) {
      ...
      double currentScale = PreferenceUtils.getDouble("current_scale") ?? 1.0;

      if(scaleDelta*currentScale>4 || scaleDelta*currentScale<0.5){
        return ;
      }
      PreferenceUtils.setDouble("current_scale", scaleDelta*currentScale);
